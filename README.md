...
This extension provides a quick and simple way to process a text file with some quickly written Javascript.

![A basic use-case](./gifs/basic_use.gif)
...
![Running saved macros](./gifs/run_saved.gif)
